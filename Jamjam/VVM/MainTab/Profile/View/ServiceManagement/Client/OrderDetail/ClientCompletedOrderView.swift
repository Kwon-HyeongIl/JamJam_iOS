//
//  ClientCompletedOrderView.swift
//  Jamjam
//
...
struct ClientCompletedOrderView: View {
    @Environment(NavigationCore.self) var navRouter
    @State private var viewModel: ClientCompletedOrderViewModel
    
    init(orderId: Int?) {
        viewModel = ClientCompletedOrderViewModel(orderId: orderId)
    }
...
#Preview {
    NavigationStack {
        ClientCompletedOrderView(orderId: nil)
