//
//  ClientCancelledOrderView.swift
//  Jamjam
//
...
struct ClientCancelledOrderView: View {
    @Environment(NavigationCore.self) var navRouter
    @State private var viewModel: ClientCancelledOrderViewModel
    
    init(orderId: Int?) {
        viewModel = ClientCancelledOrderViewModel(orderId: orderId)
    }
...
#Preview {
    NavigationStack {
        ClientCancelledOrderView(orderId: nil)
