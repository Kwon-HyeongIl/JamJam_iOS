//
//  ProviderRequestedOrderView.swift
//  Jamjam
//
...
struct ProviderRequestedOrderView: View {
    @Environment(NavigationCore.self) var navRouter
    @State private var viewModel: ProviderRequestedOrderViewModel
    
    init(orderId: Int?) {
        viewModel = ProviderRequestedOrderViewModel(orderId: orderId)
    }
...
#Preview {
    NavigationStack {
        ProviderRequestedOrderView(orderId: nil)
