//
//  ClientServiceManagementViewModel.swift
//  Jamjam
//
...
@Observable
class ClientServiceManagementViewModel {
    ...
    @ObservationIgnored let logger = Logger(subsystem: "com.khi.jamjam", category: "ClientServiceManagementViewModel")
