//
//  ClientCompletedOrderViewModel.swift
//  Jamjam
//
...
@Observable
class ClientCompletedOrderViewModel {
    ...
    @ObservationIgnored let logger = Logger(subsystem: "com.khi.jamjam", category: "ClientCompletedOrderViewModel")
